!function() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: `<svg height="30" viewBox="124.528 16 262.944 480" xmlns="http://www.w3.org/2000/svg">
                    <path d="m216.398 16h-91.87v480c30.128-7.135 61.601-10.708 91.87-12.052z" fill="#FFFFFF"/>
                    <path d="m387.472 496v-480h-91.87v468.904c53.636 3.416 91.87 11.096 91.87 11.096z" fill="#FFFFFF"/>
                    <path d="m387.472 496-171.074-480h-91.87l167.03 468.655c55.75 3.276 95.914 11.345 95.914 11.345z" fill="#FFFFFF"/>
                   </svg>`,
        ...
        },
		{
    		...
    		url: "discover/movie?with_keywords=6075&sort_by=vote_average.desc&vote_count.gte=50&include_adult=false",
    		source: "tmdb"
        },
		{
			id: 'erotica',
			...
			url: "discover/movie?with_keywords=155477|190370|207767|256466&include_adult=true&sort_by=popularity.desc&vote_count.gte=20",
			source: "tmdb"
		}
    ];
    ...
    <rect x="2" y="8" width="34" height="21" rx="3" stroke="#FFFFFF" stroke-width="3"/>
    <line x1="13.0925" y1="2.34874" x2="16.3487" y2="6.90754" stroke="#FFFFFF" stroke-width="3" stroke-linecap="round"/>
    <line x1="1.5" y1="-1.5" x2="9.31665" y2="-1.5" transform="matrix(-0.757816 0.652468 0.652468 0.757816 26.197 2)" stroke="#FFFFFF" stroke-width="3" stroke-linecap="round"/>
    <line x1="9.5" y1="34.5" x2="29.5" y2="34.5" stroke="#FFFFFF" stroke-width="3" stroke-linecap="round"/>
    <style>
        svg:hover rect,
        svg:hover line {
